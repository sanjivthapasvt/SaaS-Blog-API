...
class Notification(SQLModel, table=True):
    ...
    blog_id: Optional[int] = Field(default=None, foreign_key="blog.id", index=True, ondelete="CASCADE")
    triggered_by_user_id: int = Field(foreign_key="user.id", index=True, ondelete="CASCADE")
